...
'''
        ...
        Прочитайте его и, используя битовые операции, проверьте, 
        включен ли 5-й или 1-й биты введенного числа. 
...
flags = 74
print(bin(flags))   #   0b1001010
print("ДА" if flags & 2 == 2 or flags & 32 == 32 else "НЕТ")
