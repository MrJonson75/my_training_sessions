...
match book:
    case (*_, str(author), str(name)):
        print('Yes', 'автор, название')
    case (*_, str(author), str(name), year) if year == 2023.0 :
        print('Yes', 'автор, название, год издания')
    case (*_, str(author), str(name), float(price)):
        print('Yes', 'автор, название, цена')
    case (*_, str(author), str(name), float(price), int(year)):
        print('Yes', 'автор, название, цена, год издания')
    case _:
        print('No')
...
match book:
    case (*_, str(author), str(name)) if len(author) >= 6 and len(name) >= 10:
        print('Yes')
    case (*_, str(author), str(name), year) if year > 2020.0:
        print('Yes')
    case (*_, str(author), str(name), float(price)) if len(author) >= 6 and price > 0:
        print('Yes')
    case (*_, str(author), str(name), float(price), int(year)) if year > 2020 and price > 0:
        print('Yes')
    case _:
        print('No')